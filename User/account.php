	...
	<div id="main">
		...
		<form action="databasephp/personal_info.php" method="post">
			<table>
				...
				<tr>
					<td colspan="8" width="80px"><input type="text" name="name" size="50" style="width: 400px;height: 20px" placeholder="<?php if($data['user_name']!='') echo $data['user_name'];?>"<?php if($data['user_name']!='') echo "disabled";?>></td>
				</tr>
				<tr><td colspan="8" width="50px">Gender</td>
					<td colspan="8" width="50px">Email</td>
				</tr>
				<tr>
					<td colspan="8" width="80px"><select name="gender" style="width: 400px;height: 20px" placeholder="<?php if($data['user_gender']!='') echo $data['user_gender'];?>"<?php if($data['user_gender']!='') echo "disabled";?>>
