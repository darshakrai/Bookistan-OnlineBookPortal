...
$query1="SELECT user_mobile FROM user_details WHERE user_id='$id'";
	...
	<div id="main">
		...
		<form action="databasephp/addressbook.php" method="post">
				...
				<tr>
					...
					<td colspan="8" width="50px"><input type="text" name="mobile" placeholder="<?php if($data1['user_mobile']!='') echo $data1['user_mobile'];else echo 'Enter user mobile number'?>" size="50" style="height: 20px;width: 600px"></td>
				</tr>	
				<tr>
